...
public class NewSettingsFragment extends BaseFragment {
    ...
    private void initializeSettings(View view) {
        ...
        changeWalletSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.wallet_settings_icon)
        ...
        backUpWalletSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.backup_settings_icon)
        ...
        showSeedPhrase = new SettingsItemView.Builder(getContext())
                .withIcon(R.drawable.seed_settings_icon)
        ...
        nameThisWallet = new SettingsItemView.Builder(getContext())
                .withIcon(R.drawable.name_settings_icon)
       ...
       walletConnectSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.connect_settings_icon)
        ...
        notificationsSetting =
                new SettingsItemView.Builder(getContext())
                        ...
                        .withIcon(R.drawable.notification_settings_icon)
   ...
   /*     biometricsSetting =
        ...
        selectNetworksSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.share_settings_icon)
        ...
        advancedSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.advanced_settings_icon)
        ...
        supportSetting =
                new SettingsItemView.Builder(getContext())
                        .withIcon(R.drawable.support_settings_icon)
