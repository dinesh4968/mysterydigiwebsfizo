...
public class AWalletBottomNavigationView extends LinearLayout {
    ...
    private void deselectAll() {
        dappBrowser.setImageResource(R.drawable.dashboard);
        wallet.setImageResource(R.drawable.navigation_wallet);
        settings.setImageResource(R.drawable.navigation_settings);
        activity.setImageResource(R.drawable.navigation_search);
        //reset text colour
